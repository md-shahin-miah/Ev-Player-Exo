package com.shahin.evplayer.ui.viewmodel
...
import com.shahin.evplayer.databinding.DetailsBottomsheetDialogBinding
import com.shahin.evplayer.ui.adapter.VideoAdapter
import com.shahin.evplayer.model.Video
import com.shahin.evplayer.util.AppConstant
import com.shahin.evplayer.util.AppUtil
...
class VideoViewModel : ViewModel() {
    ...
    fun showDetailsDialog(context: Context, video: Video) {
        ...
        binding.txtDate.text = video.date_added?.let { AppUtil.getDate(it.toLong()).toString() }
